  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col items-center justify-center p-4 transition-colors relative">
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
        ...
        <p className="text-center text-gray-500 dark:text-gray-400 mb-8">Sign up to start learning with AI</p>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-sm text-gray-500 dark:text-gray-400">Or sign up with email</span>
          <div className="flex-1 h-px bg-gray-200 dark:bg-gray-700"></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-lg font-medium transition-colors disabled:opacity-70 flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
          ...
          <Link to={ROUTES.LOGIN} className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
